    ...
    switch (sectionId) {
      ...
      case "crop": {
        ...
        const rotateByRightAngle = (delta: number) => {
          ...
          updateAdjustments({
            rightAngleRotation: normalizeRightAngleRotation(
              adjustments.rightAngleRotation + delta
            ),
            ...ratioPatch,
          });
        };
          ...
          >
            ...
            {rotateSlider && (
              <EditorSliderRow
                ...
                format={(value) => value.toFixed(2)}
                onChange={(value) =>
                  previewAdjustmentValue("rotate", normalizeRotateAngle(value))
                }
                onCommit={(value) =>
                  updateAdjustmentValue("rotate", normalizeRotateAngle(value))
                }
