...
export function Editor() {
  ...
  const presetLabel = useMemo(() => {
    ...
    return allPresets.find((preset) => preset.id === selectedAsset.presetId)?.name ??
      "未设置";
  }, [allPresets, selectedAsset?.presetId]);

  const stats = selectedAsset
    ? [
        { label: "当前预设", value: presetLabel, hint: "可在左侧预设切换" },
  ...
  return (
    <PageShell
      title="单张精修"
      kicker="Lightroom 对齐"
      description="风格应用后进入精修页面，布局对齐 Lightroom，覆盖基础、颜色、曲线、细节与裁切。"
      actions={
        <>
            ...
            <aside className="space-y-3 lg:sticky lg:top-24">
              {!adjustments ? (
                ...
                <div className="space-y-3">
                  ...
                  <Section id="hsl" title="HSL 颜色精细控制" hint="Hue / Saturation / Luminance">
                    <div className="flex flex-wrap gap-2">
                  ...
                  <Section id="detail" title="细节与降噪" hint="锐化 / 降噪">
                    ...
                    <SliderRow
                      ...
                      min={0}
                      max={100}
                      onChange={(value) => updateAdjustmentValue("colorNoiseReduction", value)}
                    />
                    <p className="text-[11px] text-slate-500">
                      细节算法将逐步接入渲染管线。
                    </p>
